    ...
    <div>
      <div className="bg-white border-b border-ui-border px-4 sm:px-6 py-5 sm:py-7">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-sm text-text-secondary">{totalCount.toLocaleString()}+ verified vendors across Nigeria</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {vendors.length > 0 ? (
          <>
            <p className="text-sm text-text-secondary mb-4">{vendors.length} vendors found</p>
